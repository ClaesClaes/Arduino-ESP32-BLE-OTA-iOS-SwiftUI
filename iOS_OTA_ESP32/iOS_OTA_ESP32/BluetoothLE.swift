...
private let myDesiredCharacteristicId = CBUUID(string: "62EC0272-3EC5-11EB-B378-0242AC130005")
...
class BLEConnection:NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate{
    ...
    func writeDataToPeriheral(characteristic: CBCharacteristic) {
        ...
        chunkSize = discoveredPeripheral.maximumWriteValueLength (for: .withoutResponse)
        ...
        while transferOngoing && discoveredPeripheral.canSendWriteWithoutResponse {
